...
describe('filter filter', function () {
    ...
    it('filters an array of objects where any value matches', function () {
        ...
        expect(fn({arr: [
            ...
            {firstName: 'Marry', lastName: 'Quick'}
        ]})).toEqual([
            {firstName: 'John', lastName: 'Brown'},
            {firstName: 'Jane', lastName: 'Fox'}
        ]);
    ...
    it('filters an array of objects where a nested value matches', function () {
        ...
        expect(fn({arr: [
            ...
            {name: {firstName: 'Marry', lastName: 'Quick'}}
        ]})).toEqual([
            {name: {firstName: 'John', lastName: 'Brown'}},
            {name: {firstName: 'Jane', lastName: 'Fox'}}
        ]);
    ...
    it('ignored undefined values in expectation object', function () {
    ...
    it('filters with a nested objects on the same level only', function () {
        // var items = [
        //     {user: 'Bob'},
        //     {user: {name: 'Bob'}},
