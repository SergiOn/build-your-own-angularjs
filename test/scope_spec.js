...
describe('Scope', function () {
    ...
    describe('digest', function () {
        ...
        it('calls the listener function of a watch on first $digest', function () {
            ...
            expect(listenerFn).toHaveBeenCalledWith('wat', 'wat', scope);
        });
        ...
        it('accept expressions in $eval', function () {
            expect(scope.$eval('42')).toBe(42);
        });

        it('accept expressions in $apply', function () {
            scope.aFunction = _.constant(42);
            expect(scope.$apply('aFunction()')).toBe(42);
        });

        it('accept expressions in $evalAsync', function (done) {
            var called;
    ...
    describe('$watchCollection', function () {
        ...
        it('notices an item replaced in an arguments objects', function () {
            (function () {
        ...
        it('notices not fail on NaN attribute in objects', function () {
            scope.counter = 0;
            scope.obj = {a: NaN};
        ...
        it('notices when an attribute is removed from an objects', function () {
            scope.counter = 0;
            scope.obj = {a: 1};
    ...
    describe('Events', function () {
        ...
        _.forEach(['$emit', '$broadcast'], function (method) {
            ...
            it('passes additional arguments to listeners on ' + method, function () {
                ...
                expect(listener.calls.mostRecent().args[1]).toBe('and');
                expect(listener.calls.mostRecent().args[2]).toEqual(['additional', 'arguments']);
                expect(listener.calls.mostRecent().args[3]).toBe('...');
            });

            it('return the event object on ' + method, function () {
                var returnEent = scope[method]('someEvent');

                expect(returnEent).toBeDefined();
                expect(returnEent.name).toEqual('someEvent');
            });
