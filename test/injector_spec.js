...
describe('injector', function () {
    ...
    it('has a constant that been registered to a module', function () {
    ...
    it('loads the required modules of module', function () {
        var module1 = angular.module('myModule', []);
    ...
    it('loads the transitively required modules of module', function () {
        var module1 = angular.module('myModule', []);
        var module2 = angular.module('myOtherModule', ['myModule']);
    ...
    describe('annotate', function () {
        ...
        it('return the array-style annotations of a function', function () {
            var injector = createInjector([]);
    ...
    describe('providers', function () {
        ...
        it('registers constants first to make them available to provider', function () {
            var module = angular.module('myModule', []);
    ...
    describe('$injector', function () {
        ...
        it('allows registering config blocks with providers', function () {
            var module = angular.module('myModule', []);
