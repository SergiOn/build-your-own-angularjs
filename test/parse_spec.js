...
describe('parse', function () {
    ...
    it('looks up a 2-party identifier path from the scope', function () {
    ...
    it('does not allow accessing calling __defineGetter__', function () {
        expect(function () {
    ...
    it('does not allow accessing calling __defineSetter__', function () {
        expect(function () {
    ...
    it('does not allow calling function on DOM elements', function () {
    ...
    it('replace undefined with zero for unary +', function () {
    ...
    it('parses multiplicatives on a higher precedence that additives', function () {
    ...
    it('still returns a function when given no arguments', function () {
    ...
    it('marks function call non-constant', function () {
    ...
    it('marks binaries constant when both are constant', function () {
        expect(parse('1 + 2').constant).toBe(true);
    ...
    it('marks logicals constant when both are constant', function () {
