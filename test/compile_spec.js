...
describe('$compile', function () {
    ...
    _.forEach({
        ...
        describe('restrict to '+restrict, function () {
    ...
    it('stop compiling at a terminal directive', function () {
        var compilations = [];
        var myModule = window.angular.module('myModule', []);
        myModule.directive('firstDirective', function () {
            return {
    ...
    describe('attributes', function () {
        ...
        it('pass the element attributes to the compile function', function () {
            registerAndCompile(
                'myDirective',
        ...
        it('set prop for boolean attributes', function () {
            registerAndCompile(
                'myDirective',
                '<input my-directive>',
                function (element, attrs) {
        ...
        it('set prop for boolean attributes even when not flushing', function () {
            registerAndCompile(
                'myDirective',
                '<input my-directive>',
                function (element, attrs) {
        ...
        it('terminates class directive value at semicolon', function () {
            registerAndCompile(
                'myDirective',
    ...
    describe('linking', function () {
        ...
        it('add class and data for element with isolated scope', function() {
            var givenScope;
            var injector = makeInjectorWithDirectives('myDirective', function() {
                return {
                    scope: {},
        ...
        it('set initial value of observed attr to the isolate scope', function() {
            var givenScope;
            var injector = makeInjectorWithDirectives('myDirective', function() {
                return {
                    scope: {
        ...
        it('allows aliasing observed attribute', function() {
            ...
            injector.invoke(function($compile, $rootScope) {
                var el = $('<div my-directive an-attr="42"></div>');
                $compile(el)($rootScope);
                expect(givenScope.aScopeAttr).toBe('42');
            });
        });
        ...
        it('allows aliasing expression attribute to isolate scope', function() {
            var givenScope;
            var injector = makeInjectorWithDirectives('myDirective', function() {
                return {
                    scope: {
        ...
        it('allows passing arguments to parent scope expression', function() {
            ...
            injector.invoke(function($compile, $rootScope) {
                ...
                var el = $('<div my-directive my-expr="parentFunction(argFromChild) + 1"></div>');
                $compile(el)($rootScope);
        ...
        it('set missing optional parent scope expression to undefined', function() {
            var givenScope;
            var injector = makeInjectorWithDirectives('myDirective', function() {
                return {
                    scope: {
    ...
    describe('controllers', function () {
        ...
        it('has isolate scope bindings available during constructor', function () {
            var gotMyAttr;
            function MyController($scope) {
        ...
        it('allows optional market after parent market', function () {
            var gotCtrl;
            var injector = createInjector(['ng', function ($compileProvider) {
                $compileProvider.directive('myDirective', function () {
                    return {
        ...
        it('allows optional market before parent market', function () {
            function MyController() { }
            var gotMyController;
            var injector = createInjector(['ng', function ($compileProvider) {
                $compileProvider.directive('myDirective', function () {
    ...
    describe('template', function () {
        ...
        it('replace any existing children', function () {
            var injector = makeInjectorWithDirectives('myDirective', function () {
                return {
                    template: '<div class="from-template"></div>'
                };
        ...
        it('supports functions as template value', function () {
    ...
    describe('transclude', function () {
        ...
        it('makes content available to directive link function', function () {
            var injector = makeInjectorWithDirectives({
                myTranscluder: function () {
                    return {
                        transclude: true,
        ...
        it('do not use the inherited scope of the directive', function () {
            var injector = makeInjectorWithDirectives({
                myTranscluder: function () {
                    return {
                        transclude: true,
        ...
        it('support passing transclusion function to public link function', function () {
            var injector = makeInjectorWithDirectives({
    ...
    describe('clone attach function', function () {
        ...
        it('causes compiled element to be cloned', function () {
            var injector = makeInjectorWithDirectives({});
            injector.invoke(function($compile, $rootScope) {
                var el = $('<div>Hello</div>');
                var myScope = $rootScope.$new();
                ...
                $compile(el)(myScope, function cloneAttachFn(cloneEl) {
                    gotCloneEl = cloneEl;
                });

                expect(gotCloneEl[0].isEqualNode(el[0])).toBe(true);
                expect(gotCloneEl[0]).not.toBe(el[0]);
            });
        });
        ...
        it('causes cloned DOM to be linked', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                ...
                expect(gotCompiledEl[0]).not.toBe(gotLinkedEl[0]);
            });
        });
    ...
    describe('element transclusion', function () {
        ...
        it('replaces the element with a comment', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                ...
                expect(el.html()).toBe('<!-- myTranscluder:  -->');
            });
        });
        ...
        it('includes directive attribute value in comment', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                ...
                expect(el.html()).toBe('<!-- myTranscluder: 42 -->');
            });
        });
        ...
        it('calls directive compile and link with comment', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                ...
                expect(gotCompileEl[0].nodeType).toBe(Node.COMMENT_NODE);
        ...
        it('calls lower priority compile with original', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                ...
                expect(gotCompileEl[0].nodeType).toBe(Node.ELEMENT_NODE);
            });
        });
        ...
        it('compile original element contents once', function () {
            var compileSpy = jasmine.createSpy();
            var injector = makeInjectorWithDirectives({
                myTranscluder: function () {
                    return {transclude: 'element'};
        ...
        it('makes original element available for transclusion', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                var el = $(
                    '<div><div my-double>Hello</div></div>');
        ...
        it('sets directive attributes element to comment', function () {
            ...
            injector.invoke(function($compile, $rootScope) {
                var el = $(
                    '<div><div my-transcluder></div></div>');
    ...
    describe('interpolate', function () {
        ...
        it('is done for text nodes', function () {
            ...
            injector.invoke(function ($compile, $rootScope) {
                ...
                $rootScope.$apply();
                expect(el.html()).toBe('My expression: ');

                $rootScope.myExpr = 'Hello';
                $rootScope.$apply();
                expect(el.html()).toBe('My expression: Hello');
            });
        });
        ...
        it('is done for attributes', function () {
            ...
            injector.invoke(function ($compile, $rootScope) {
                ...
                $rootScope.myAltText = 'My favorite photo';
                $rootScope.$apply();
                expect(el.attr('alt')).toBe('My favorite photo');
            });
        });
        ...
        it('fires observers on attribute expression changes', function () {
           ...
           injector.invoke(function ($compile, $rootScope) {
               ...
               $rootScope.$apply();
               expect(observerSpy.calls.mostRecent().args[0]).toBe('My favourite photo');
           });
        });
        ...
        it('is done for attributes so that compile-time changes apply', function () {
           ...
           injector.invoke(function ($compile, $rootScope) {
               ...
               expect(el.attr('my-attr')).toBe('Other Hello');
           });
        });
