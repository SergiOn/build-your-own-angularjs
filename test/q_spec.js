...
describe('$q', function () {
    ...
    it('may have multiple callback', function () {
        var d = $q.defer();
    ...
    it('invoke callback once', function () {
        var d = $q.defer();
    ...
    it('can rejected a deferred', function () {
        var d = $q.defer();
    ...
    it('can rejected just once', function () {
        var d = $q.defer();
    ...
    it('reject chained promise when handler throws', function () {
        var d = $q.defer();
    ...
    it('transform progress through handlers', function () {
        var d = $q.defer();
        var progressSpy = jasmine.createSpy();
    ...
    it('recover from progressback exception', function () {
        var d = $q.defer();
        var progressSpy = jasmine.createSpy();
        var fulfilledSpy = jasmine.createSpy();
    ...
    it('can make an immediately resolved promise with resolve', function () {
        var fulfilledSpy = jasmine.createSpy();
        var rejectedSpy = jasmine.createSpy();
    ...
    describe('all', function () {
        ...
        it('resolve an empty array of promises immediately', function () {
            var promise = $q.all([]);
            var fulfilledSpy = jasmine.createSpy();
            promise.then(fulfilledSpy);
        ...
        it('resolve an empty object of promises immediately', function () {
            var promise = $q.all({});
            var fulfilledSpy = jasmine.createSpy();
            promise.then(fulfilledSpy);
    ...
    describe('ES6 style', function () {
        ...
        it('calls function with a rejected function', function () {
            var fulfilledSpy = jasmine.createSpy();
            var rejectedSpy = jasmine.createSpy();
